...
export const mockFoodItems: FoodItem[] = [
  // Salads (28 items)
  { id: "salad-1", category_id: "cat-salads", name: "מטבוחה", has_liters: true, is_active: true, sort_order: 1, created_at: new Date().toISOString() },
  { id: "salad-2", category_id: "cat-salads", name: "חציל מטוגן", has_liters: true, is_active: true, sort_order: 2, created_at: new Date().toISOString() },
  { id: "salad-3", category_id: "cat-salads", name: "חציל במיונז", has_liters: true, is_active: true, sort_order: 3, created_at: new Date().toISOString() },
  { id: "salad-4", category_id: "cat-salads", name: "חציל זעלוק", has_liters: true, is_active: true, sort_order: 4, created_at: new Date().toISOString() },
  { id: "salad-5", category_id: "cat-salads", name: "חציל בלאדי", has_liters: true, is_active: true, sort_order: 5, created_at: new Date().toISOString() },
  { id: "salad-6", category_id: "cat-salads", name: "סלק", has_liters: true, is_active: true, sort_order: 6, created_at: new Date().toISOString() },
  { id: "salad-7", category_id: "cat-salads", name: "גזר מבושל", has_liters: true, is_active: true, sort_order: 7, created_at: new Date().toISOString() },
  { id: "salad-8", category_id: "cat-salads", name: "גזר חי", has_liters: true, is_active: true, sort_order: 8, created_at: new Date().toISOString() },
  { id: "salad-9", category_id: "cat-salads", name: "פלפל חריף", has_liters: true, is_active: true, sort_order: 9, created_at: new Date().toISOString() },
  { id: "salad-10", category_id: "cat-salads", name: "חומוס", has_liters: true, is_active: true, sort_order: 10, created_at: new Date().toISOString() },
  { id: "salad-11", category_id: "cat-salads", name: "טחינה", has_liters: true, is_active: true, sort_order: 11, created_at: new Date().toISOString() },
  { id: "salad-12", category_id: "cat-salads", name: "ערבי", has_liters: true, is_active: true, sort_order: 12, created_at: new Date().toISOString() },
  { id: "salad-13", category_id: "cat-salads", name: "ירקות", has_liters: true, is_active: true, sort_order: 13, created_at: new Date().toISOString() },
  { id: "salad-14", category_id: "cat-salads", name: "חסה", has_liters: true, is_active: true, sort_order: 14, created_at: new Date().toISOString() },
  { id: "salad-15", category_id: "cat-salads", name: "כרוב", has_liters: true, is_active: true, sort_order: 15, created_at: new Date().toISOString() },
  { id: "salad-16", category_id: "cat-salads", name: "חמוצי הבית", has_liters: true, is_active: true, sort_order: 16, created_at: new Date().toISOString() },
  { id: "salad-17", category_id: "cat-salads", name: "זיתים", has_liters: true, is_active: true, sort_order: 17, created_at: new Date().toISOString() },
  { id: "salad-18", category_id: "cat-salads", name: "מלפפון בשמיר", has_liters: true, is_active: true, sort_order: 18, created_at: new Date().toISOString() },
  { id: "salad-19", category_id: "cat-salads", name: "קונסולו", has_liters: true, is_active: true, sort_order: 19, created_at: new Date().toISOString() },
  { id: "salad-20", category_id: "cat-salads", name: "כרוב אדום במיונז", has_liters: true, is_active: true, sort_order: 20, created_at: new Date().toISOString() },
  { id: "salad-21", category_id: "cat-salads", name: "כרוב אדום חמוץ", has_liters: true, is_active: true, sort_order: 21, created_at: new Date().toISOString() },
  { id: "salad-22", category_id: "cat-salads", name: "תירס ופטריות", has_liters: true, is_active: true, sort_order: 22, created_at: new Date().toISOString() },
  { id: "salad-23", category_id: "cat-salads", name: "פול", has_liters: true, is_active: true, sort_order: 23, created_at: new Date().toISOString() },
  { id: "salad-24", category_id: "cat-salads", name: "מיונז", has_liters: true, is_active: true, sort_order: 24, created_at: new Date().toISOString() },
